...
export default function Treasury() {
    ...
    return (
        <div className="max-w-screen-xl flex flex-col gap-12 lg:mx-auto p-4 mt-12 pb-44">
            ...
            <div>
                <div className="flex justify-center items-center fmb text-[12px] font-normal  gap-5 sm:gap-0">
                    ...
                    <div className="flex-1 flex justify-center items-center gap-2 sm:gap-20">
                        <h1 className="text-end">Holdings</h1>
                    </div>
                    <div className="flex-1 flex justify-center items-center gap-2 sm:gap-20">
                        <h1 className="text-end">Value</h1>
                    </div>
                </div>
                <hr
                    className="my-8"
                ...
                <div className="flex flex-col gap-10">
                    {vasData
                        ...
                        .map((item, index) => (
                            <div
                                key={index}
                                className="flex justify-center items-center bg-[#E78A74] py-5 gap-5 sm:gap-0 text-[14px] font-semibold"
                                style={{
                                    borderRadius: "5px",
                                    background: "rgba(231, 138, 116, 0.15)",
                                }}
                            >
                                <div className="flex-1 flex justify-start items-center gap-0 sm:gap-20">
